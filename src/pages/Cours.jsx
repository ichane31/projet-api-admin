...
import { GetProjet, PutCourse, DelCourse } from "../service/CourseService";
...
const Cours = () => {
  ...
  const findIdCategory = (name) => {
    const _category = categories.filter((item) => item.name === name);
    ...
    try {
      ...
      if (!res.ok) {
        ...
        toast.current.show({
          severity: "success",
          summary: "Réussi",
          detail: "Le Cours supprimé avec succès",
          life: 3000,
        });
      }
    } catch (err) {
  ...
  const deleteSelectedCategories = async () => {
    ...
    allDelelted === selectedCourses.length &&
      toast.current.show({
        severity: "success",
        summary: "Réussi",
        detail: "les courses supprimés avec succès",
        life: 3000,
      });
  };
      ...
      <div className="flex">
        ...
        <div className="mt-2 mb-3 mx-1 p-0">
          <Button
            ...
            className=" m-0 p-button-outlined"
            onClick={clearFilter}
          />{" "}
        </div>{" "}
        <div className="mt-2 mb-3 mx-1 p-0">
  ...
  return (
    <>
      <Helmet>
        <script>document.title = "Cours" </script>{" "}
      </Helmet>{" "}
        ...
        {!isLoading ? (
          <div className="card">
            ...
            >
              ...
              <Column
                field="Nchapiters"
                header="Nombre de Chapiter"
                body={nchapitersBodyTemplate}
                style={{ minWidth: "10rem" }}
              >
                {" "}
              </Column>{" "}
          ...
          <div className="card py-4">
            ...
            <Skeleton height={30} /> <Skeleton count={8} height={25} />{" "}
          </div>
        )}{" "}
        {course.id ? (
          <Dialog
          ...
          >
            <Formik
              initialValues={{
                ...
                category: findIdCategory(course.category),
                ...
                try {
                  ...
                  if (res.ok) {
                    ...
                    toast.current.show({
                      ...
                      detail: "Le cours a été modifie avec succès",
                      life: 3000,
                    });
                        ...
                        onChange={(e) => {
                          ...
                          if (!file.type.match(imageMimeType)) {
                            toast.current.show({
                              severity: "danger",
                              summary: "Faild",
                              detail: "Image mime type is not valid",
                              life: 3000,
                            });
                            return;
                          }
        ...
        >
          <div className="confirmation-content">
            ...
            {course && (
              <span>
                {" "}
                Êtes - vous sûr de vouloir supprimer <b> {course.name} </b>?
              </span>
            )}{" "}
          </div>{" "}
        </Dialog>
        ...
        >
          <div className="confirmation-content">
            ...
            {course && (
              <span>
                {" "}
                Êtes - vous sûr de vouloir supprimer les course sélectionnés ?{" "}
              </span>
            )}{" "}
          </div>{" "}
        </Dialog>{" "}
