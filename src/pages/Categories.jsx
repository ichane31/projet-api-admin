...
const Categories = () => {
    ...
    const actionBodyTemplate = (rowData) => {
        return (
            <React.Fragment>
                <Button icon="pi pi-pencil" className="p-button-rounded p-button-info mr-3" onClick={() => editCategory(rowData)} />
        ...
        <div className="datatable-crud">
            ...
            <div className="card">
                <DataTable ref={dt} value={categories}  stripedRows removableSort selection={selectedCategories}
                    ...
                    <Column field="projet" header="Projets" body={projetBodyTemplate}></Column>
